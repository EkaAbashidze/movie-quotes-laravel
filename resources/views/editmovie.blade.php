...
<div class="flex flex-row h-screen w-full">
    ...
    <div class="flex flex-col flex-1 bg-gray-100 p-8">
        ...
        <form method="POST" action="{{ route('movies.update') }}" class="w-[1000px] bg-white rounded-lg p-8 shadow-lg">
            @csrf
            @method('PUT')
            <div class="mb-4">
                <label for="title" class="block text-gray-700 font-bold mb-2">{{ __('messages.edit') }}</label>
