<div class="flex flex-col bg-blue-dark text-white w-64">
  ...
  <ul class="flex flex-col p-8">
    ...
    <li class="py-2 hover:underline"><a href="{{ route('admin.dashboard') }}#movies_list">{{ __('messages.movies_list') }}</a></li>
    <li class="py-2 hover:underline"><a href="{{ route('admin.dashboard') }}#quotes_list">{{ __('messages.quotes_list') }}</a></li>
